  [15]= { showBlip = false,locked = false, camers = {x = 2434.716, y = -398.107, z = 92.994, heading = 110.223}, driveout = {x = 2434.716, y = -398.107, z = 92.994, heading = 110.223}, drivein = {x = 2434.716, y = -398.107, z = 92.994, heading = -65.339}, outside = {x = 2434.716, y = -398.107, z = 92.994, heading = -65.339}, inside = {x = 2434.716, y = -398.107, z = 92.994, heading = -65.339} },
}
...
local function AddMod(mod,parent,header,name,info,stock)
	...
	if (GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) > 0) or mod == 18 or mod == 22 then
		...
		if LSC_Config.prices.mods[mod].startprice then
          ...
          local dict_name = blrp_mod_dictionary[lbl]
					if mname ~= "NULL" then
						local btn = m:addPurchase(mname,price)
						btn.modtype = mod
						btn.mod = i
						price = price + LSC_Config.prices.mods[mod].increaseby
          elseif dict_name ~= nil then
						local btn = m:addPurchase(dict_name,price)
						btn.modtype = mod
						btn.mod = i
						price = price + LSC_Config.prices.mods[mod].increaseby
					end
...
local function DriveInGarage(is_local)
    ...
    if vehicle_names[GetEntityModel(veh)] ~= nil then
		...
		if vehicle_type ~= "boats" and vehicle_type ~= "planes" and vehicle_type ~= "helicopters" then
			if not protected and GetEntityModel(veh) ~= `hellion` then
			...
			if vehicle_type ~= "boats" and not police_fleet then
      ...
      if not protected or police_fleet then
...
local function DriveOutOfGarage(pos)
    ...
    if vehicle_names[model] ~= nil then
      ...
      if args ~= nil then
        plate = args[1]
        LSCserver.updateVehicle({vehicle_names[model][1],myveh.mods,vcolor1,vcolor2,ecolor1,ecolor2,myveh.wheeltype,myveh.plateindex,myveh.windowtint,smokecolor1,smokecolor2,smokecolor3,neoncolor1,neoncolor2,neoncolor3,neon,plate})
      end
    end
	...
	while true do
		...
		if inside == false then
			...
			if IsPedSittingInAnyVehicle(ped) then
              ...
              if #(vector3(outside.x,outside.y,outside.z) - (GetEntityCoords(ped))) <= 20 then
								DrawMarker(23, outside.x,outside.y,outside.z-1+0.01, 0, 0, 0, 0, 0, 0, 3.0001, 3.0001, 1.5001, 255, 165, 0,165, 0, 0, 0,0)
							end
              if #(vector3(outside.x,outside.y,outside.z) - (GetEntityCoords(ped))) <= 5 then
                        ...
                        vRPserver.hasPermission_client({'customs.editlocals'}, function(has_permission)
                          local is_local = not IsEntityAMissionEntity(veh)

                          if pos.local_only and not is_local then
                            Notify('You cannot modify this vehicle here')
                            return
                          end

                          if IsEntityAMissionEntity(veh) or has_permission then
  													inside = true
  													currentpos = pos
  													currentgarage = i
                      ...
                      vRPserver.hasPermission_client({'customs.editlocals'}, function(has_permission)
                        ...
                        if IsEntityAMissionEntity(veh) or has_permission then
							...
							if math.abs(GetEntityHeading(veh)-outside.heading) <= 90 and IsVehicleStopped(veh) and #(vector3(outside.x,outside.y,outside.z) - (GetEntityCoords(ped))) <= 5 then
								--Lets check if our vehicle is not in the model black list, and if it is not then we can go further
								if not tableContains(LSC_Config.ModelBlacklist,GetDisplayNameFromVehicleModel(GetEntityModel(veh)):lower()) then
									--If the garage is locked
									if pos.locked then
...
function LSCMenu:onButtonSelected(name, button, is_local)
	--Send the selected button to server
	LSCserver.buttonSelected({name, button, currentgarage, is_local})
end
