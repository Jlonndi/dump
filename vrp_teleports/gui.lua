...
function gui_interiors_OpenMenu()
	...
	gui_interiors.selectedbutton = 1
end
-------------------------------------------------
----------------FONCTION CLOSE-------------------
-------------------------------------------------
...
Citizen.CreateThread(function()
	while true do
        ...
        if (Vdist(playerPos.x, playerPos.y, playerPos.z, Teleports[POS_actual].x, Teleports[POS_actual].y, Teleports[POS_actual].z) > 0.5) then
      ...
      local y = gui_interiors.menu.y + 0.12
			...
			menu.buttons = {}
			for i,dest in pairs(Teleports[POS_actual].destination) do
				table.insert(menu.buttons , Teleports[dest])
			end
