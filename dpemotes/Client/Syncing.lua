...
AddEventHandler("ClientEmoteRequestReceive", function(target, emotename, etype)
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(5)
        if IsControlJustPressed(1, 246) and isRequestAnim and false then -- hard code disabled with false
