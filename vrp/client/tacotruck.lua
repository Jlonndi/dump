...
function tacoTruck.switchToBack()
  ...
  local vehicleId = NetworkGetNetworkIdFromEntity(vehicle)
  SetEntityCoords(playerPed, vehiclePos.x, vehiclePos.y, vehiclePos.z, true, true, true, false)
  ...
  Citizen.CreateThread(function()
    while inBackofTruck do
      ...
      if IsControlJustReleased(1, Keys['F']) then
        SetEntityCoords(playerPed, vehiclePos.x - 2, vehiclePos.y, vehiclePos.z, true, true, true, false)
        inBackofTruck = false
