    ...
    commands: [
        {
            ...
            items: [
                ...
                {
                    command: '/ad',
                    info: 'Post an ad in chat for $1000'
                },
                {
                    command: '/tablet',
                ...
                {
                    command: '/mutequit',
                    info: 'Toggle quit message visibility'
                },
                {
                    command: '/notepad',
        ...
        },
        {
            ...
            items: [
                ...
                },
                {
                    command: '/seat',
                    args: '{number (0-4+)}',
                    info: 'Get into a specific seat of a vehicle'
                },
            ],
        },
        {
    ...
    hotkeys: [
        ...
        },
        {
            ...
            items: [
                ...
                {
                    pressKey: 'User Defined',
                    info: 'This is configured in Teamspeak settings',
                },
            ]
        },
        {
