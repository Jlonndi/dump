...
DiamondPenthouse = {
    ...
    LoadDefault = function()
        ...
        DiamondPenthouse.Interior.Pattern.Set(DiamondPenthouse.Interior.Pattern.pattern08)
        ...
        DiamondPenthouse.Interior.Arcade.Set(DiamondPenthouse.Interior.Arcade.retro)
        DiamondPenthouse.Interior.Clutter.Set(DiamondPenthouse.Interior.Clutter.bar)
