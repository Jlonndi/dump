...
function EnableGui(enable, shopType)
	...
	if not enable then
		TriggerEvent("CustomScript:ZoomTranstion", "client.lua@L12")
	end
end
...
AddEventHandler('disclaimer:display', function(value)
	EnableGui(value)
	-- I really dont want to add time to this but want to see if it solves the issue for christopher black
